...
class HorizontalCardPager extends StatefulWidget {
  ...
  @override
  HorizontalCardPagerState createState() => HorizontalCardPagerState();
}

class HorizontalCardPagerState extends State<HorizontalCardPager> {
  ...
  void initState() {
    ...
    updateHorizontalCurrentPlaylist = true;
  }

  @override
  void dispose() {
    updateHorizontalCurrentPlaylist = false;
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < widget.items!.length; i++) {
      ...
      Widget card = Positioned.directional(
          ...
          top: _getTopPosition(cardHeight, widget.cardMaxHeight!),
...
double _getTopPosition(double cardHeigth, double viewHeight) {
