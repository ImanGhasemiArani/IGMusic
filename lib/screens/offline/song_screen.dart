...
import '../../widgets/button/btn_favorite.dart';
import '../../widgets/button/btn_loop_mode.dart';
import '../../widgets/button/btn_play_pause.dart';
import '../../widgets/button/btn_set_speed.dart';
import '../../widgets/button/btn_set_timer.dart';
import '../../widgets/button/btn_skip_next.dart';
import '../../widgets/button/btn_skip_previous.dart';
import '../../widgets/button/tap_effect.dart';
import '../../widgets/card/card_effective_playlist_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          padding: EdgeInsets.only(left: threeDotRP),
          child: TapEffect(
            onTap: () => Get.back(),
            child: const Icon(
              Icos.down_arrow_2,
        ...
        actions: [
          Padding(
            padding: EdgeInsets.only(right: threeDotRP),
            child: TapEffect(
              onTap: () => Get.back(),
              child: const Icon(
                Icos.dots,
